...
@MapperScan(value = { "com.snackpub.core.redis.aop.db.mapper" }, sqlSessionFactoryRef = "sqlSessionFactory")
@ConditionalOnProperty(name = "snackpub.druid.datasource.url", matchIfMissing = false)
public class DbOneDruidDataSourceConfiguration {

    /**
     * mapper.xml文件的地址
     */
    static final String MAPPER_LOCATION = "classpath:com/snackpub/core/redis/aop/db/mapper/*Mapper.xml";

    @Autowired
    private DruidDataSourceProperties dbOneDruidDataSourceProperties;
